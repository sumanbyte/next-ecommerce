...
const ChangePassword = () => {
  ...
  return (
    <>
      <p className="text-center bg-secondary-300 py-2">
        Please don&apos;t refresh the page until you change your password.
      </p>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 mt-10">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <h1 className="font-bold text-2xl cursor-pointer text-center font-comfortaa">
            ShopWave
          </h1>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form
            ...
            action="#"
            method="POST"
            onSubmit={(e) => changepassword(e, token, userId)}
          >
            <div>
              <label
                htmlFor="password"
