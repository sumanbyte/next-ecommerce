    ...
    <div className='max-w-7xl m-auto'>
      <div className='my-10 px-2 md:px-4'>
        ...
        <div className='flex gap-2'>
          ...
          <div className='flex gap-2 items-center'>
            <select className='px-2 py-1' defaultValue={""}>
          ...
          {cartItems?.map((cartItem: any) => (
            <div key={cartItem._id} className='bg-white grid grid-cols-[2fr_1fr_1fr_1fr_1fr] justify-items-center items-center py-5 text-center'>
              ...
              <div className="flex items-center gap-5">
                <FaMinus color='black' onClick={() => handleIncreaseQuantity(cartItem.productId._id)} className='rounded-sm' />
                <p className='text-lg'>{cartItem.quantity}</p>
                <FaPlus color='black' onClick={() => handleIncreaseQuantity(cartItem.productId._id)} className=' rounded-sm' />
              </div>
              <div>
