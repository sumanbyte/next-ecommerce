...
export default function Navbar() {
  ...
  useEffect(() => {
    AxiosInstance.get("/api/auth/verify")
      .then((res) => {
  ...
  return (
    <>
      <header onMouseLeave={modalLeaveState} className=" bg-primary-500 m-auto">
        <nav className="container w-full h-14 text-primary-100 flex items-center justify-between lg:justify-normal">
          ...
          <div className="font-comfortaa">
            <Link href={"/"}>
              <h1 className="font-bold text-2xl cursor-pointer text-center lg:text-left">
                ShopWave
              </h1>
            </Link>
          </div>
          ...
          <div className="w-1/3 lg:w-full flex justify-end lg:justify-between ml-0 mr-0 lg:ml-6">
            <div className="gap-2 lg:gap-3  font-size text-base font-medium font-chakrapetch hidden lg:flex">
              <Category
                type="1"
                text="categories"
                state={navbarState.categories}
              />
              <Category type="2" text="brands" state={navbarState.brands} />
              <Category
                type="3"
                text="collections"
                state={navbarState.collections}
              />
              <Category
                type="4"
                text="deals_and_offers"
                state={navbarState.deals_and_offers}
              />
            ...
            <div>
              <div className="flex gap-7 items-center">
                <div
                  className="flex items-center gap-5 cursor-pointer hover:text-red-700 duration-500"
                  onClick={() => {
                    dispatch(changeNav({ type: "7", selectedText: "search" }));
                  }}
                >
                  <FiSearch className="text-xl font-bold" />
                  <span className="text-sm font-light font-montserrat hidden lg:block">
                    Search
                  </span>
                </div>
                ...
                {auth.isAuthenticated && (
                  <div
                    className="hover:text-red-700 duration-500 cursor-pointer mr-4 hidden lg:block"
                    onClick={() => {
      ...
      <div
        className={`bg-primary-400 text-primary-100 w-[300px] h-mobileNav overflow-scroll absolute z-10 transform transition duration-500 ${
          navbarState.mobilemenu ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        <div className="menus">
          <div className="menu flex flex-col mx-2 my-5">
            <div>
              <input
                ...
                className="hidden"
                id="checkbox"
                checked={navbarState.categories}
                readOnly
              />
              <label
                className="text-xl"
                htmlFor="checkbox"
                onClick={() => {
                  dispatch(changeNav({ type: "1", hasMobile: true }));
                }}
              >
                Categories{" "}
                <span>
                  <BiChevronDown
                    className={`inline transform ${
                      navbarState.categories ? "rotate-180" : ""
                    }`}
                  />
                </span>
              </label>
          ...
          <div className="menu flex flex-col mx-2 my-5">
            <div>
              ...
              <label
                ...
                htmlFor="checkbox"
                onClick={() => {
                  dispatch(changeNav({ type: "2", hasMobile: true }));
                }}
              >
                Brands{" "}
                <span>
          ...
          <div className="menu flex flex-col mx-2 my-5">
            <div>
              <input
                ...
                className="hidden"
                id="checkbox"
                checked={navbarState.collections}
                readOnly
              />
              <label
                className="text-xl"
                htmlFor="checkbox"
                onClick={() => {
                  dispatch(changeNav({ type: "3", hasMobile: true }));
                }}
              >
                Collections{" "}
                <span>
                  <BiChevronDown
                    className={`inline transform ${
                      navbarState.collections ? "rotate-180" : ""
                    }`}
                  />
                </span>
              </label>
          ...
          <div className="menu flex flex-col mx-2 my-5">
            <div>
              <input
                ...
                className="hidden"
                id="checkbox"
                checked={navbarState.deals_and_offers}
                readOnly
              />
              <label
                className="text-xl"
                htmlFor="checkbox"
                onClick={() => {
                  dispatch(changeNav({ type: "4", hasMobile: true }));
                }}
              >
                Deals and Offers{" "}
                <span>
                  <BiChevronDown
                    className={`inline transform ${
                      navbarState.deals_and_offers ? "rotate-180" : ""
                    }`}
                  />
                </span>
              </label>
          ...
          <div className="menu flex flex-col mx-2 my-5">
            <div>
              ...
              <label
                ...
                htmlFor="checkbox"
                onClick={() => {
                  dispatch(changeNav({ type: "5", hasMobile: true }));
                }}
              >
                Support{" "}
                <span>
                  <BiChevronDown
                    className={`inline transform ${
                      navbarState.support ? "rotate-180" : ""
                    }`}
                  />
                </span>
              </label>
          ...
          <div className="menu flex flex-col mx-2 my-5">
            <div>
              ...
              <label
                ...
                htmlFor="checkbox"
                onClick={() => {
                  dispatch(changeNav({ type: "6", hasMobile: true }));
                }}
              >
                Options{" "}
                <span>
                  <BiChevronDown
                    className={`inline transform ${
                      navbarState.options ? "rotate-180" : ""
                    }`}
                  />
                </span>
              </label>
          ...
          <div className="menu flex mx-2 my-5 gap-2">
            {auth.isLoading && !auth.isAuthenticated ? (
              ...
              <>
                {" "}
                <Link href={"/auth/login"} className="px-2 py-1 bg-primary-700">
                  Login
                </Link>
                <Link
                  href={"/auth/signup"}
                  className="px-2 py-1 bg-secondary-700"
                >
                  Signup
                </Link>
              </>
              ...
              <>
                ...
                <Link
                  href={"#"}
                  className="px-2 py-2 bg-red-500 text-sm transition-transform hover:scale-105 active:scale-95"
                  onClick={logout}
                >
                  Logout
                </Link>
