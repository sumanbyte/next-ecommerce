...
export default function FooterNewsLetter() {
    return <div className="bg-gray-500">
        <div className="flex flex-col md:flex-row justify-between items-center bg-gray-500 py-10 px-2 md:px-4 max-w-7xl m-auto ">
            <div className="flex w-full justify-center md:justify-normal">
                ...
                <button className='p-1.5  md:p-2.5 text-xs md:text-lg bg-secondary-500 uppercase font-extrabold'>SUBSCRIBE</button>
            </div>
