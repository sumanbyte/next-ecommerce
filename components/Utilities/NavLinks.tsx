    ...
    <div className="pt-4 mx-6 ">
      <div className="flex items-center shadow-2xl shadow-blue-500/20">
        <div
          ...
          className="bg-secondary-700 hover:bg-secondary-800 transition cursor-pointer h-full py-1.5 md:px-2 rounded-tl-md rounded-bl-md flex items-center justify-center"
        >
          <AiOutlineSearch className="text-4xl" />
        </div>
        <input
          className="px-1 text-black py-1 md:px-2 md:py-2 text-base md:text-lg w-full outline-none rounded-tr-md rounded-br-md placeholder:md:text-lg  placeholder:text-base placeholder:tracking-wider"
          type="text"
